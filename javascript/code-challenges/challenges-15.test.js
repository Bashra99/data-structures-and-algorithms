...
const screenForNames = (arr) => {
  ...
  return arr.filter(
    (item) =>
      /^([Dr.]+\s)+[a-zA-Z]+$/.test(item) ||
      /^([Mrs.]+\s)+[a-zA-Z]+$/.test(item)
  );
};
...
const detectTicTacToeWin = (board) => {
  ...
  if (r1 === r2 && r2 === r3 && r1 !== "") {
    ...
    return true;
  } else if (d1 === d2 && d2 === d3 && d1 !== "") {
    return true;
  } else if (r1 === c1 && c1 === d1 && r1 !== "") {
    return true;
  } else if (r2 === c2 && c2 === d2 && r2 !== "") {
    return true;
  } else if (r3 === c3 && c3 === d3 && r3 !== "") {
    return true;
  } else if (r1 === c2 && c2 === d3 && r1 !== "") {
    return true;
  } else if (r3 === c2 && c2 === d1 && r3 !== "") {
    return true;
  } else {
    return false;
  }
