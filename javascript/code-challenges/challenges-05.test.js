...
const addValues = (arr) => {
  // Solution code here...
  const toReturn = arr.reduce((previousValue, currentValue) => previousValue+currentValue,0);
  return toReturn;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return(arr.reduce((lastValue, nowValue, index) => {
    lastValue + nowValue
    return index+1}));
